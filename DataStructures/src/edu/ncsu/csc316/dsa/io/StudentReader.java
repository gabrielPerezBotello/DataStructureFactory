...
public class StudentReader {
	...
	private static Student processLine(String line) {
		// Creates scanner for line string and sets delimiter for commas
		Scanner tokenReader = new Scanner(line);
		tokenReader.useDelimiter(",");

		String first = tokenReader.next();
		String last = tokenReader.next();
		String unityID = tokenReader.next();
		int id = tokenReader.nextInt();
		double gpa = tokenReader.nextDouble();
		int creditHours = tokenReader.nextInt();
