...
public abstract class AbstractMap<K, V> implements Map<K, V> {
	...
	protected static class MapEntry<K, V> implements Entry<K, V> {
		/** Field that holds the key value for the current entry. */
		private K key;
		/** Field that holds the value for the current entry. */
		private V value;
	...
	protected class EntryCollection implements Iterable<Entry<K, V>> {
		/** List of Entry objects to be used for this class. */
		...
		private class EntryCollectionIterator implements Iterator<Entry<K, V>> {
			/** Iterator object that iterates through Entry objects. */
	...
	protected class KeyIterator implements Iterator<K> {
		/** Iterator object that uses Entry objects to iterate. */
		private Iterator<Entry<K, V>> it;
	...
	/**
	 * Creates a private inner class to wrap your ValueIterator into an Iterable
	 * object.
	 * 
	 * @author Gabriel Perez-Botello
	 *
