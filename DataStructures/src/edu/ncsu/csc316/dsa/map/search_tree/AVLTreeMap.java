 ...
 * 
 * The properties of an AVL tree ensure O(logn) height, and O(logn) worst-case
 * performance for {@see Map#put}, {@see Map#get}, and {@see Map#remove}.
 *
...
public class AVLTreeMap<K extends Comparable<K>, V> extends BinarySearchTreeMap<K, V> {
	 ...
	 * 
	 * @param compare a comparator to help with comparing nodes within the AVL tree
	 */
