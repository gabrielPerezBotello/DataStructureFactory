...
/**
 * An EdgeListGraph is an implementation of the {@link Graph} abstract data
 * type. EdgeListGraph maintains a list of vertices in the graph and a list of
 * edges in the graph.
 * 
...
public class EdgeListGraph<V, E> extends AbstractGraph<V, E> {
	/** The list of vertices for the graph. */
