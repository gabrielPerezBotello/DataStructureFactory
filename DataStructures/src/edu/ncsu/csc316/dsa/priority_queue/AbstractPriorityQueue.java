...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/** Comparator object to compare elements in the queue. */
	...
	public class NaturalOrder implements Comparator<K> {
		/** 
		 * Compare method used for natural ordering of elements. 
		 * 
		 * @param first the first element being compared
		 * @param second the second element being compared
		 * @return int determining the ordering for the pair of elements
		 */
	...
	public static class PQEntry<K, V> implements Entry<K, V> {
		/** Key field for an entry for PriorityQueue object. */
		private K key;
		/** Value field for an entry for PriorityQueue object. */
		private V value;
	 ...
	 * @return Entry object for the Priority Queue
	 */
