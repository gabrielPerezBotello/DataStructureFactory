...
/**
 * Tests MergeSorter.java class's selection sorter algorithm along with it's
...
public class MergeSorterTest {
	...
	/**
	 * MergeSorter object to be used for testing the MergeSorter.java class.
	 */
	private MergeSorter<Student> studentSorter;
	/**
	 * MergeSorter object to be used for testing the MergeSorter.java class.
	 */
	private MergeSorter<Student> studentSorter1;
	...
	/**
	 * Sets up integerSorter as a new MergeSorter object to help keep tests
	 * repeatable.
	 */
	@Before
	public void setUp() {
		studentSorter = new MergeSorter<Student>(gpaComp);
		studentSorter1 = new MergeSorter<Student>(idComp);
	}
